    ...
    let matches = App::new(env!("CARGO_PKG_NAME"))
            ...
            .subcommand(
                App::new("buy")
                    ...
                    .help(" The way we call it is: buy --size '$100' --asset eth --price @1900 --sl 1920 --tp 1865")
                    .arg(
            ...
            .subcommand(
                App::new("sell")
                    ...
                    .help(" The way we call it is: sell --size '$100' --asset eth --price @1900 --sl 1920 --tp 1865")
                    .arg(
                        Arg::with_name("order_size")
                            .help("size of the order e.g ., $100 ")
                            .long("size")
