...
example: `hl tp 10% btc 5` - sets a take profit order for 10% of the order size for btc with a take profit of 5%

example: `hl tp 30% btc +$300` - sets a take profit order for 30% of the order size for btc with a take profit of $300

example `hl tp 100% sol +300pnl` - sets a take profit order for 100% of the order size for sol with a take profit of 300pnl
...
example: `hl sl 10% btc 5` - sets a stop loss order for 10% of the order size for btc with a stop loss of 5%

example: `hl sl 30% btc -$300` - sets a stop loss order for 30% of the order size for btc with a stop loss of $300

example `hl sl 100% sol -300pnl` - sets a stop loss order for 100% of the order size for sol with a stop loss of 300pnl
...
example 1: `hl buy --size 100 --asset btc --price 1900 --sl 1800 --tp 2000` - places a buy order for 100 usd worth of btc at the price of $1900. The stop loss will be set at $1800 and the take profit will be set at $2000

example 2: `hl buy --size 100 --asset btc --price 1900` - places a buy order for 100 usd worth of btc at the price of $1900. The stop loss and take profit will not be set

example 3: `hl buy --size 100 --asset btc` - places a buy order for 100 usd worth of btc at the current market price. The stop loss and take profit will not be set
...
example 1: `hl sell --size 100 --asset btc --price 1900 --sl 1800 --tp 2000` - places a sell order for 100 usd worth of btc at the price of $1900. The stop loss will be set at $1800 and the take profit will be set at $2000

example 2: `hl sell --size 100 --asset btc --price 1900` - places a sell order for 100 usd worth of btc at the price of $1900. The stop loss and take profit will not be set

example 3: `hl sell --size 100 --asset btc` - places a sell order for 100 usd worth of btc at the current market price. The stop loss and take profit will not be set
...
example: `hl twap sell 100 eth 5,10` - places a twap sell order for 100 usd. The order will be divided into 10 pieces and each piece will be sold every 5 minutes.
...
example 1: `hl pair buy 100 btc/eth --price 0.05 --sl 0.04 --tp 0.06` - Takes 50% of order size and longs btc and takes another 50% of order size and shorts eth in a pair. The ratio of btc/eth is 0.05 so the bot will enter the trade when the ratio is 0.05. The stop loss will be set at 0.04 and the take profit will be set at 0.06

example 2: `hl pair buy 100 btc/eth` - Takes 50% of order size and longs btc and takes another 50% of order size and shorts eth in a pair. The current market price of btc/eth will be used to enter the trade. The stop loss and take profit will not be set

example 3: `hl pair buy 100 btc/eth --price 0.05` - Takes 50% of order size and longs btc and takes another 50% of order size and shorts eth in a pair. The ratio of btc/eth is 0.05 so the bot will enter the trade when the ratio is 0.05. The stop loss and take profit will not be set
...
example 1: `hl pair sell 100 btc/eth --price 0.05 --sl 0.04 --tp 0.06` - Takes 50% of order size and shorts btc and takes another 50% of order size and longs eth in a pair. The ratio of btc/eth is 0.05 so the bot will enter the trade when the ratio is 0.05. The stop loss will be set at 0.04 and the take profit will be set at 0.06

example 2: `hl pair sell 100 btc/eth` - Takes 50% of order size and shorts btc and takes another 50% of order size and longs eth in a pair. The current market price of btc/eth will be used to enter the trade. The stop loss and take profit will not be set

example 3: `hl pair sell 100 btc/eth --price 0.05` - Takes 50% of order size and shorts btc and takes another 50% of order size and longs eth in a pair. The ratio of btc/eth is 0.05 so the bot will enter the trade when the ratio is 0.05. The stop loss and take profit will not be set
...
size*per_interval:[\_required*] is a forward slash separated string of the size of each interval and the number of intervals i.e 100/10.
...
example: `hl scale buy 100/10 eth 1800 1890` - Scales into a long position by placing limit orders at intervals between 1800 and 1890. 100 eth will be divided over 10 orders (10eth per order). Since there are 10 number of intervals, there will be 10 buy orders placed between 1800 and 1890:
...
example: `hl scale sell 100/10 eth 1800 1890` - Scales into a short position by placing limit orders at intervals between 1800 and 1890. 100 eth will be divided over 10 orders (10eth per order). Since there are 10 number of intervals, there will be 10 sell orders placed between 1800 and 1890:
